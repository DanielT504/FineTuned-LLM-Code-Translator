...
int n = mat . GetLength ( 0 ) ; int m = mat . GetLength ( 1 ) ;
int count = 0 ;
int totalSum = 0 ;
...
using System ; class GFG { public static int [ ] countSum ( int [ ] arr , int n ) {
...
public static void Main ( String [ ] args ) { int [ ] arr = new int [ ] { 1 , 2 , 2 , 3 } ; int n = 4 ; int [ ] ans = countSum ( arr , n ) ; Console . WriteLine ( " EvenSum ▁ = ▁ " + ans [ 0 ] ) ; Console . WriteLine ( " OddSum ▁ = ▁ " + ans [ 1 ] ) ; } }
...
String str = String . Join ( " " , s ) ; Console . WriteLine ( str ) ; }
