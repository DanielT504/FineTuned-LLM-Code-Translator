...
public static int longestSubSequence ( int [ ] [ ] A , int N ) { return longestSubSequence ( A , N , 0 , 0 , 0 ) ; }
public static void main ( String args [ ] ) {
...
class initials { static void printInitials ( String name ) { if ( name . length ( ) == 0 ) return ;
String words [ ] = name . split ( " ▁ " ) ; for ( String word : words ) { System . out . print ( Character . toUpperCase ( word . charAt ( 0 ) ) + " ▁ " ) ; } }
public static void main ( String args [ ] ) { String name = " prabhat ▁ kumar ▁ singh " ; printInitials ( name ) ; } }
